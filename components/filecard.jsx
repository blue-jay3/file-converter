...
const FileCard = ({selectedFile, onFileTypeChange, filename, downloadUrl, selectedFileType, clearUpload}) => {
    ...
    return (
        <>
            <div className="flex mt-24 mx-auto w-[500px] h-[150px] p-5 rounded-lg border text-lg text-slate-500 border-slate-400 bg-slate-50">
